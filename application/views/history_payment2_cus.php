        ...
        <div class="row">
            <center>
                <div class="alert alert-dark" role="alert">
                    <h3>รายละเอียดการชำระเงินงวดที่ 2</h3>
                </div>
            </center>
            <div class="col-5">
                <br>
            ...
            <div class="col-6">
                ...
                <form action="upload_file2" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="status" value="รอตรวจสอบการชำระเงินงวดที่2" hidden>
                    <br>
                    ...
                    <center>
                        ...
                        <a href="<?php echo site_url('Contract_Controller/history_success2_cus') ?>" type="button" class="btn btn-primary">ย้อนกลับ</a>
                        <!-- Modal -->
