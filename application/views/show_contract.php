...
<div class="row">
    ...
    ชื่อบัญชี <?php echo $item->account_name ?> เลขที่บัญชี <?php echo $item->account_number ?> ทั้งนี้ ผู้ว่าจ้าง ตกลงเป็นผู้รับภาระ เงินค่าธรรมเนียม หรือค่าบริการอื่นใด
...
<br>
    <center>
        <a href="<?php echo site_url('Welcome/history')?>" type="button" class="btn btn-primary">กลับ</a>
    </center>
<br>