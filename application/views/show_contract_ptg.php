...
<div class="row">
    ...
    <form action="success_contract" method="POST">
        ...
        <input type="text" name="status" value="รอการชำระเงิน" hidden>
        <input class="btn btn-info" type="submit" value="ตกลง">         
    </form>
    </div>
    <div class="col-1">
    <form action="delete_contract_ptg" method="POST">
        <input type="number" name="cm_id" value="<?php echo $item->cm_id ?>" hidden>
        <input class="btn btn-danger" type="submit" value="ไม่รับงาน">         
    </form>
    </div>
    <div class="col-5"></div>
    </div>
