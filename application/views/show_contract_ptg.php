...
<?php foreach ($query as $item) { ?>
    <div class="container">
        ...
        <div class="row">
            ...
            <h6>การจ่ายเงิน ตามเงื่อนไข แห่งสัญญานี้ ผู้ว่าจ้าง จะโอนเงินเข้า ชื่อบัญชี บริษัท Photographer Gallery จำกัด เลขที่บัญชี 000-1-00000-1 ทั้งนี้ ผู้ว่าจ้าง ตกลงเป็นผู้รับภาระ
                <br>เงินค่าธรรมเนียม หรือค่าบริการอื่นใดเกี่ยวกับการโอนที่ธนาคารเรียกเก็บ.
            </h6>
        </div><br>
        <center>
            <div class="row">
                ...
                <div class="col-1">
                    <a href="<?php echo site_url('Contract_Controller/history_ptg') ?>" type="button" class="btn btn-primary">ย้อนกลับ</a>
                </div>
                <div class="col-4"></div>
            </div>
        </center>
