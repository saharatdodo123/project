    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <h6>จังหวัด <?php echo $item->province ?> ในวันที่ <?php echo $item->day_month_year ?> เวลา <?php echo $item->time ?> ถึง <?php echo $item->to_time ?> ตามข้อกำหนดและเงื่อนไข
        ...
        <div class="row">
            <div class="col-1"> </div>
            <div class="col-11">
                <h5>ข้อ 2. เอกสารอันเป็นส่วนหนึ่งของสัญญา</h5>
        ...
        <div class="row">
            ...
            <div class="col-11">
                ...
                <h6>ไฟล์งานทั้งหมดให้แก่ผู้ว่าจ้างเรียบรอยแล้ว</h6>
            </div>
            <h6>การจ่ายเงิน ตามเงื่อนไข แห่งสัญญานี้ ผู้ว่าจ้าง จะโอนเงินเข้า ชื่อบัญชี บริษัท Photographer Gallery จำกัด เลขที่บัญชี 000-1-00000-1 ทั้งนี้ ผู้ว่าจ้าง ตกลงเป็นผู้รับภาระ เงินค่าธรรมเนียม หรือค่าบริการอื่นใด
                ทั้งนี้ ผู้ว่าจ้าง ตกลงเป็นผู้รับภาระ เงินค่าธรรมเนียม หรือค่าบริการอื่นใดเกี่ยวกับการโอนที่ธนาคารเรียกเก็บ.</h6>
        </div><br>
    </div>
    <br>
    <center>
        <a href="<?php echo site_url('Contract_Controller/history_paymentsuccess_ptg') ?>" type="button" class="btn btn-primary">ย้อนกลับ</a>
    </center>
    <br>
    </div>
<?php } ?>
